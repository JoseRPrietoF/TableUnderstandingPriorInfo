...
class Arguments(object):
    ...
    def __init__(self, logger=None):
        ...
        general.add_argument(
            ...
            default="NO",
            type=str,
            choices=["NO", "ROW", "COL", "CELL", "ALL", "CR", "SPAN"],
            help="Logging level",
        )
        general.add_argument(
            "--do_prune",
        ...
        general.add_argument(
            ...
            default="CELLS",
            type=str,
            choices=["HEADER", "CELLS", "EDGES", "spans"],
            help="Logging level",
        )
        general.add_argument(
            "--multihead",
            default=False,
            type=bool,
            help="multihead to use with differents types of layouts",
        )
        general.add_argument(
            "--numConvsHead",
            default=1,
            type=int,
            help="Num of the convs per head",
        )
