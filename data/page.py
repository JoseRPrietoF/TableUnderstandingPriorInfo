...
class TablePAGE():
    ...
    def __init__(self, im_path, debug=False,
                 search_on=["TextLine"], hisClima=False, info_attributes=False, IoU=False, IoU_tl=[], IoU_path=""):
        """
        ...
        if hisClima:
            # for every table
            if not info_attributes and not IoU:
    ...
    def get_cellsWithText(self, prod:bool=False):
        """
        Return all the cells in a PAGE
        :return: [(coords, col, row)], dict, dict
        """
    ...
    def get_cellsWithTextHisClima(self, prod:bool=False):
        """
        Return all the cells in a PAGE
        :return: [(coords, col, row)], dict, dict
        """
    ...
    def get_textLinesFromCell(self, maxWidth=9999999, info_attributes=False, empty_cells=False, prod=False):
        """
        A partir de un elemento del DOM devuelve, para cada textLine, sus coordenadas y su contenido
        :param dom_element:
        :return: [(coords, words)]
    ...
    def get_textLinesHisClima(self, maxWidth=9999999, info_attributes=False, empty_cells=False, prod=False):
        """
        A partir de un elemento del DOM devuelve, para cada textLine, sus coordenadas y su contenido
        :param dom_element:
        :return: [(coords, words)]
